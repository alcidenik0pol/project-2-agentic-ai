...
from app.api.routes import analysis, health, results
...
# Import from project root (avoiding shadowing with backend's app folder)
from app.project_imports import config
