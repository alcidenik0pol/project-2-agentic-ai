...
You need at least two data points, ideally three, that show the same underlying mechanic appearing independently. Not the same company iterating. Different companies, same solution to the same problem.

Ask yourself: have I seen this before? Where? What happened?
